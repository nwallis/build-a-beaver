...
var Item = function(params) {
    ...
    this.sku = params.sku || '';
    this.id = params.id;
    this.productName = params.productName || 'No name';
    this.alternatePrice = params.alternatePrice;
    this.alternateSku = params.alternateSku;
    this.alternateProductName = params.alternateProductName;
